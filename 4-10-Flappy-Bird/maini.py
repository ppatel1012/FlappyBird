...
def main():
    ...
    bird = mySprites.Bird()
    # create CityBackground, Pipe sprite and Ground sprite objects from our mySprites module
    city = mySprites.CityBackground(screen)
    ground = mySprites.Ground(screen)
    pipes = mySprites.Pipes(screen)

    # add our sprites to an OrderedUpdates Sprite Group to keep Refresh section simple
    allSprites = pygame.sprite.OrderedUpdates(city, ground, pipes, bird)
